            ...
            <nav id="sidebar">
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        <li >
                            <a href="clientdashboard.php"  role="button" aria-expanded="false" class="nav-link"><i class="fa big-icon fa-home"></i> <span class="mini-dn">Dashboard</span> </a>
                        </li>
                        <li class="active" style="background-color: #03a9f0">
                            <a href="clientservices.php"  role="button" aria-expanded="false" class="nav-link"><i class="fa big-icon fa-book"></i> <span class="mini-dn">Select Services</span> </a>
                        </li>
                                    ...
                                    <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                ...
                                                <span class="admin-name">Client</span>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                ...
                                <div class="sparkline13-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                        <button class="btn btn-success btn-sm btn-round" data-toggle="modal" data-target="#add"><i class="fa fa-book"></i> Book Now!</button> 
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="false" data-show-refresh="true" data-key-events="true" data-show-toggle="false" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="true" data-toolbar="#toolbar">
                                            ...
                                            <tbody>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td>10:00am</td>
                                                    <td class="datatable-ct"><span class="btn  btn-xs"></span></td>
                                                    <td class="datatable-ct"><button class="btn btn-danger btn-xs"><i class="fa fa-times"></i></button></td>
                                                </tr>
                                                <tr>
                                                    <td>Data</td>
                                                    <td>Data</td>
                                                    ...
                                                    <td>January 17, 2020</td>
                                                    <td>10:00am</td>
                                                    <td class="datatable-ct"><span class="btn btn-success btn-xs">Approved</span></td>
                                                    <td class="datatable-ct"><button class="btn btn-danger btn-xs"><i class="fa fa-times"></i></button></td>
                                                </tr>
                                            </tbody>
                                        </table>
